...
/* package xmonad-config-0.0 */
#ifndef VERSION_xmonad_config
#define VERSION_xmonad_config "0.0"
...
/* package xmonad-0.17.2 */
#ifndef VERSION_xmonad
#define VERSION_xmonad "0.17.2"
...
#define TOOL_VERSION_gcc "14.0.5"
#endif /* TOOL_VERSION_gcc */
#ifndef MIN_TOOL_VERSION_gcc
#define MIN_TOOL_VERSION_gcc(major1,major2,minor) (\
  (major1) <  14 || \
  (major1) == 14 && (major2) <  0 || \
  (major1) == 14 && (major2) == 0 && (minor) <= 5)
...
#define CURRENT_COMPONENT_ID "xmonad-config-0.0-inplace-xmonad-config"
